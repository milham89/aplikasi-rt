...
import { User, Phone, Mail, MapPin, Hash, Briefcase, ShieldCheck, LogOut, Settings, X, Save, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-10 pb-20">
      ...
      <div className="flex flex-col items-center py-6">
        <div className="relative group">
          <div className="absolute inset-0 bg-emerald-500 rounded-[3rem] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity"></div>
          <div className="h-32 w-32 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-[3rem] flex items-center justify-center text-white shadow-2xl relative z-10 border-4 border-white dark:border-slate-800">
            <User className="h-16 w-16" />
          </div>
        </div>
        <h2 className="text-2xl font-black text-slate-800 dark:text-white mt-6 tracking-tight uppercase">{resident?.full_name}</h2>
